...
const SideNavigationBar = () => {
    ...
    return (
        <Navbar className="d-flex flex-column position-fixed p-4 bg-body min-vh-100 border-end"
                style={{width: "inherit"}}>
            <NavLink to="/" className="d-flex align-items-center text-decoration-none border-0 w-100 px-1 mb-5 rounded">
                <span className="d-inline px-3 py-1 me-1 bg-dark rounded text-center text-secondary"><svg
                    xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#FFFFFF" class="bi bi-app-indicator"
                    viewBox="0 0 16 16">
                    <path
            ...
            <Nav className="d-flex flex-column w-100">
                <Nav.Item className="my-2">
                    <NavLink to="/" className="d-flex align-items-center text-decoration-none px-1 py-2 custom rounded">
                        {isActive("/") ? <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#212529"
                                              class="bi bi-house-door-fill" viewBox="0 0 16 16">
                            <path
                                d="M6.5 14.5v-3.505c0-.245.25-.495.5-.495h2c.25 0 .5.25.5.5v3.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5Z"/>
                        </svg> : <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#212529"
                ...
                <Nav.Item className="my-2">
                    <NavLink to="/events"
                             className="d-flex align-items-center text-decoration-none px-1 py-2 custom rounded">
                        {isActive("/events") ?
                ...
                <Nav.Item className="my-2">
                    <NavLink to="/notifications"
                        ...
                        <span className="px-2 fs-6 text-dark">Notifications</span>
                    </NavLink>
                </Nav.Item>
            </Nav>
        </Navbar>
